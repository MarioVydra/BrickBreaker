...
public class Platno {
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("BlueJ Shapes Demo", 550, 800, 
                                         Color.white);
        }
    ...
    public class PopisTvaru implements IPopisTvaru {
        private Shape tvar;
    ...
    public class PopisObrazku implements IPopisTvaru {
